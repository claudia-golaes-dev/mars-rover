...
export function VideoText({
  ...
  useEffect(() => {
    const updateSvgMask = () => {
      ...
      const newSvgMask = `<svg xmlns='http://www.w3.org/2000/svg' width='auto' height='100%'><text x='50%' y='35%' font-size='${responsiveFontSize}' font-weight='${fontWeight}' text-anchor='${textAnchor}' dominant-baseline='${dominantBaseline}' font-family='${fontFamily}'>${content}</text></svg>`;
